...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DGleKH6w.js
var router_DGleKH6w_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Dhfi4c-2.css";
var APP_NAME = "Bravado";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Dallas Jensen. Short-form editor for Bitcoiners, podcasters, and influencers. Cuts that hold."
			},
			{
				name: "theme-color",
				content: "#0b0b0c"
...
var $$splitComponentImporter = () => import("./routes-BdewwnrW.mjs");
...
//#endregion
export { getRouter, router_DGleKH6w_exports as t };
